...
#==============================================================================================================
                elif text.lower() == "help" or text.lower() == "help1":
                    helpmessagee = helpmsg
                    client.sendMessage(to, str(helpmessagee))
                elif text.lower() == "self" or text.lower() == "help2":
                    helpselfbot = helpself
                    client.sendMessage(to, str(helpselfbot))
                elif text.lower() == "fiture" or text.lower() == "help3":
                    helpftr = helpfiture
                    client.sendMessage(to, str(helpftr))
                elif text.lower() == "update" or text.lower() == "help3":
                    helpup = helpupdate
                    client.sendMessage(to, str(helpup))
                elif text.lower() == "group" or text.lower() == "help4":
                    helpgc = helpgroup
                    client.sendMessage(to, str(helpgc))
                elif text.lower() == "reader" or text.lower() == "help5":
                    helprd = helpread
                    client.sendMessage(to, str(helprd))
                elif text.lower() == "author" or text.lower() == "help6":
                    helpaut = helpauthor
                    client.sendMessage(to, str(helpaut))
                elif text.lower() == "stealing" or text.lower() == "help7":
                    helpst = helpsteal
                    client.sendMessage(to, str(helpst))
                elif text.lower() == "spaming" or text.lower() == "help8":
                    helpsp = helpspam
                    client.sendMessage(to, str(helpsp))
                elif text.lower() == "settings" or text.lower() == "help9":
                    helpsett = helpset
                    client.sendMessage(to, str(helpsett))
                elif text.lower() == "banning" or text.lower() == "help10":
                    helpbn = helpban
                    client.sendMessage(to, str(helpbn))
                elif text.lower() == "translate" or text.lower() == "help11":
                    helptr = helptrans
                    client.sendMessage(to, str(helptr))
                elif text.lower() == "lyric" or text.lower() == "help12":
                    helply= helplyric
                    client.sendMessage(to, str(helply))
                elif text.lower() == "youtube" or text.lower() == "help13":
                    helpyt = helpytube
                    client.sendMessage(to, str(helpyt))
                elif text.lower() == "camera" or text.lower() == "help14":
                    helpcm = helpcam
                    client.sendMessage(to, str(helpcm))
                elif text.lower() == "music" or text.lower() == "help15":
                    helpmc = helpmusic
                    client.sendMessage(to, str(helpmc))
                elif text.lower() == "kaskus" or text.lower() == "help16":
                    helpks = helpkus
                    client.sendMessage(to, str(helpks))
                elif text.lower() == "soundcloud" or text.lower() == "help17":
                    helpsd = helpsound
                    client.sendMessage(to, str(helpsd))
                elif text.lower() == "news" or text.lower() == "help18":
                    helpnw = helpnews
                    client.sendMessage(to, str(helpnw))
                elif text.lower() == "province" or text.lower() == "help19":
                    helppv = helpprov
                    client.sendMessage(to, str(helppv))
                elif text.lower() == "brainly" or text.lower() == "help20":
                    helpbr = helpbran
                    client.sendMessage(to, str(helpbr))
                elif text.lower() == "lyric" or text.lower() == "help21":
                    helprik = helpry
...
#==============================================================================================================
                    ...
                    A = hasil.text
                    client.sendMessage(msg.to, A)
                elif msg.text.lower() == "autorespon on":
                    settings["detectMention"] = True
                    client.sendMessage(msg.to,"Autorespon has been Enabled")
                elif msg.text.lower() == "autorespon off":
                    settings["detectMention"] = False
                    client.sendMessage(msg.to,"Autorespon  has been Disabled")
                elif msg.text.lower() == "responchat on":
                    settings["detectMentionPM"] = True
                    client.sendMessage(msg.to,"Response Chat has been Enabled")
                elif msg.text.lower() == "responchat off":
                    settings["detectMentionPM"] = False
                    client.sendMessage(msg.to,"Response Chat has been Disabled")
                elif msg.text.lower().startswith("setresponchat: "):
                    text = msg.text.lower().replace("setresponchat: ","")
                    settings["pmMessage"] = text
                    client.sendMessage(msg.to, "Success Update Response Chat to : {}".format(str(settings["pmMessage"])))
                    ...
                    if settings["detectMentionPM"] == True:
                        ...
                        for mention in mentionees:
                            if clientMID in mention["M"]:
                                sendMention(sender, sender, "「Auto Respon chat」\n", "\n" + str(settings["pmMessage"]))
                                break
                if msg.contentType == 0: 
                    if 'MENTION' in msg.contentMetadata.keys()!= None:
                        names = re.findall(r'@(\w+)', text)
                            ...
                            if clientMID in mention["M"]:
                                ...
                                if settings["detectMention"] == True:
                                    ...
                                    if "@!" in settings["mentionPesan"]:
                                        ...
                                        return sendMention(to, sender, "Auto Respon\n" + msg_[0], msg_[1])
                                    sendMention(receiver, sender, "Auto Respon:\nHalo", "{}".format(str(settings['mentionPesan'])))
                                break
                if 'MENTION' in msg.contentMetadata.keys() != None:
                    if settings["notag"] == True:
                        ...
                        for mention in mentionees:
                            if clientMID in mention["M"]:
                               client.sendMessage(msg.to, "I said the fuck up !")
                ...
                if msg.contentType == 0:
                    if msg.toType == 0:
                        if settings["responpm"] == True:
                            sendMention(sender, sender, "Hello", "saya sedang offline, PM nanti :)")
#==============================================================================================================
                if msg.contentType == 13:
...
#==============================================================================================================
                        if cmd == "tts":
                            ...
                            string = cmd.replace("updatestatus", "")
                            if len(string) <= 10000000000:
...
#==============================================================================================================
                            ...
                            if 'MENTION' in msg.contentMetadata.keys()!= None:
                                ...
                                client.sendMessage(to, "Success Add " + str(contact.displayName) + " to Friendlist")
                            ...
                            if 'MENTION' in msg.contentMetadata.keys()!= None:
                                ...
                                client.sendMessage(to, "Success Add {} to Blocklist".format(str(contact.displayName)))
...
#==============================================================================================================
                            ...
                            for x in range(jml):
                                ...
                                client.sendMessage(to, "{} group call invitation has been send".format(str(jml)))
                            ...
                            for x in range(jml):
                                if 'MENTION' in msg.contentMetadata.keys()!= None:
                                    ...
                                    for receiver in lists:
                                        ...
                                        client.sendMessage(to, "Total {} gift has been sent".format(str(jml)))
                                    else:
                                        pass
                        elif cmd.startswith("blank "):
                            sep = text.split(" ")
                            text = text.replace(sep[0] + " ","")
                            cond = text.split(" ")
                            jml = int(cond[0])
                            ...
                            for x in range(jml):
                                if 'MENTION' in msg.contentMetadata.keys()!= None:
                                    ...
                                    for receiver in lists:
                                        ...
                                        client.sendMessage(to, "Total {} blank has been sent".format(str(jml)))
                                    else:
                                        pass
#==============================================================================================================
...
#==============================================================================================================
                            ...
                            sendMention(to, gCreator, "Hello", "Salken Owner")
                        elif cmd == "memberlist":
                            ...
                            try:
                    	        sendMention(to, sender, "「 This is Me 」\n•", "")
...
#==============================================================================================================
                        elif cmd == "mystickers" or cmd == " gift sticker 1":
                            a = int("1")
                            b = int("1000")
                            c = str("EN")
                            ...
                            for x in d.productList:
                                ...
                                no += 1
                                jmlh.append(x.title)
                            ret_ += "\n「 Total {} Stickers 」".format(str(len(jmlh)))
                        ...
                        elif cmd == "reader on" or cmd == "cek sider:on":
                            try:
                        ...
                        elif cmd == "reader off" or cmd == "cek sider:off":
...
#==============================================================================================================
                            ...
                            if settings["autoJoinTicket"] == True: md+="Autojoinqr「On」\n"
                            else: md+="Autojoinqr「Off」\n"
                            if settings["checkContact"] == True: md+="Dietailuser「On」\n"
                            else: md+="Detailuser「Off」\n"
                            if settings["unsendMessage"] == True: md+="Resendchat「On」\n"
                            else: md+="Resendchat「Off」\n"
                            if settings["detectMention"] == True: md+="Autorespon「On」\n"
                            else: md+="Autorespon「Off」\n"
                            if settings["detectMentionPM"] == True: md+="Responchat「On」\n"
                            else: md+="Responchat「Off」\n"
                            if settings["welcomeMessage"] == True: md+="Welcomemsg「On」\n"
                            else: md+="Welcomemsg「Off」\n"
                            if settings["leaveMessage"] == True: md+="Leavemsg 「On」\n"
                            else: md+="Leavemsg「Off」\n"
                            if settings["notag"] == True: md+="Notag「On」\n"
                            else: md+="Notag「Off」\n"
                            if settings["autoReply"] == True: md+="Sleepmode「On」\n"
                            else: md+="Sleepmode「Off」\n"
                            if settings["sticker"] == True: md+="Antisticker「On」\n"
                            else: md+="Antisticker「Off」"
                            client.sendMessage(to,md+"")
                            
#====================
                        elif cmd == "autoadd on":
                            settings["autoAdd"] = True
                            client.sendMessage(to, "Autoadd has been enabled")
                        elif cmd == "autoadd off":
                            settings["autoAdd"] = False
                            client.sendMessage(to, "Autoadd has been disabled")
#====================
                        elif cmd == "autojoinqr on":
                            settings["autoJoinTicket"] = True
                            client.sendMessage(to, "Autojoinqr has been enabled")
                        elif cmd == "autojoinqr off":
                            settings["autoJoinTicket"] = False
                            client.sendMessage(to, "Autojoinqr has been disabled")
#====================
#====================
                        elif cmd == "detailuser on" or cmd == "k on":
                            settings["checkContact"] = True
                            client.sendMessage(to, "Detail has been enabled")
                        elif cmd == "detailuser off" or cmd == "k off":
                            settings["checkContact"] = False
                            client.sendMessage(to, "Detail has been disabled")
#====================
...
#====================
                            ...
                            client.sendMessage(to, "Autojoin set to Author")
                        elif cmd == "autojoin off":
                            settings["autoJoin"] = False
                            client.sendMessage(to, "Autojoin has been disabled")
#====================
                        elif cmd == "autoleave on":
                            settings["autoLeave"] = True
                            client.sendMessage(to, "AutoLeave has been enabled")
                        elif cmd == "autoleave off":
                            settings["autoLeave"] = False
                            client.sendMessage(to, "AutoLeave has been disabled")
#====================
                        ...
                        elif cmd == "sticker on" or cmd == " sticker on":
                            settings["checkSticker"] = True
                            client.sendMessage(to, "Check stickers has been enabled")
                        elif cmd == "sticker off":
                            settings["checkSticker"] = False
                            client.sendMessage(to, "Check stickers has been disabled")
                            ...
                            client.sendMessage(to, "Succes actived auto block")
                        elif cmd == "autoblock off":
                            settings["autoBlock"] = False
                            client.sendMessage(to, "Succes deadactived auto block")
                        elif cmd == "notag on":
                            settings["notag"] = True
                            client.sendMessage(to, "Notag has been enabled")
                        elif cmd == "notag off":
                            settings["notag"] = False
                            client.sendMessage(to, "Now , fun is over :')")
                        elif cmd == "leavemsg on":
                            settings["leaveMessage"] = True
                            client.sendMessage(to, "Success activated Leave Message")
                        elif cmd == "leavemsg off":
                            settings["leaveMessage"] = False
                            client.sendMessage(to, "Success deactived Leave Message")
                        elif cmd == "welcomemsg on":
                            settings["welcomeMessage"] = True
                            client.sendMessage(to, "Success activated Welcome Message")
                        elif cmd == "welcomemsg off":
                            settings["welcomeMessage"] = False
                            client.sendMessage(to, "Success deactived Welcome Message")
                        ...
                        elif cmd == "getreader on":
                            settings["getReader"][receiver] = []
                            client.sendMessage(to, "Getreader has been enabled")
                            ...
                            client.sendMessage(to, "AutoRead has been disabled")
                        elif cmd == "getreader off":
                            if receiver in settings["getReader"]:
                                del settings["getReader"][receiver]
                                client.sendMessage(to, "Getreader has been disabled")
                        elif cmd == "antisticker on" or cmd == "/nosticker:0":
                                settings["sticker"] = True
                                client.sendMessage(to,"Anti Sticker has been Enabled")
                        elif cmd == "antisticker off" or cmd == "/nosticker:1":
                                settings["sticker"] = False
                                client.sendMessage(to,"Anti Sticker has been Disabled")
                        elif cmd == "sleepmode":
                            ...
                            client.sendMessage(to, "Success delete sticker")
                        elif cmd.startswith("setleavemsg: "):
                            text_ = cmd.replace("setleavemsg:", "")
                            try:
                            ...
                            client.sendMessage(to, "Success delete sticker")
                        elif cmd.startswith("setwelcomemsg: "):
                            text_ = cmd.replace("setwelcomemsg:", "")
                            try:
                            ...
                            client.sendMessage(to, "Succes deleted sticker")
                        elif cmd.startswith("setautoadd: "):
                            text_ = cmd.replace("setautoadd:", "")
                            try:
                        ...
                        elif cmd == "addautoresponsticker":
                            settings["messageSticker"]["addStatus"] = True
                            settings["messageSticker"]["addName"] = "responSticker"
                            client.sendMessage(to, "please send a sticker if you want to add")
                        elif cmd == "delautoresponsticker":
                            settings["messageSticker"]["listSticker"]["responSticker"] = None
                            client.sendMessage(to, "Succes deleted sticker")
                        elif cmd.startswith("setautorespon: "):
                            text_ = cmd.replace("setautorespon:", "")
                            try:
                                settings["mentionPesan"] = text_
                                client.sendMessage(to,"Autorespon Changed to : " + text_)
                            except:
                                client.sendMessage(to,"Autorespon\nFailed to replace message")
                        elif cmd == "addgetreadersticker":
                            settings["messageSticker"]["addStatus"] = True
                            settings["messageSticker"]["addName"] = "readerSticker"
                            client.sendMessage(to, "please send a sticker if you want to add")
                        elif cmd == "delgetreadersticker":
                            settings["messageSticker"]["listSticker"]["readerSticker"] = None
                            client.sendMessage(to, "Succes deleted sticker")
                        elif cmd.startswith("setgetreader: "):
                            text_ = cmd.replace("setgetreader:", "")
                            try:
...
#==============================================================================#
                        elif msg.text.lower().startswith("mimic:add "):
                            targets = []
                            key = eval(msg.contentMetadata["MENTION"])
                            key["MENTIONEES"][0]["M"]
                            for x in key["MENTIONEES"]:
                            ...
                            for target in targets:
                                try:
                                    ...
                                    break
                        elif msg.text.lower().startswith("mimic:del "):
                            targets = []
                            key = eval(msg.contentMetadata["MENTION"])
                            key["MENTIONEES"][0]["M"]
                            for x in key["MENTIONEES"]:
                            ...
                            if len(wbanlist) > 0:
                                ...
                                client.sendMessage(msg.to,"Wbanlist is empty!")
#==============================================================================================================
...
#==============================================================================================================
                            ...
                            if 'MENTION' in msg.contentMetadata.keys()!= None:
                                ...
                                client.sendMessage(to, "Success Delete Friendlist")
                        elif cmd == "motivation":
                             try:                                                                           
...
#=========================================================================================
                            ...
                            try:
                                ...
                                client.sendMessage(to, str(error))
                        elif cmd.startswith("youtube-vid "):
                            try:
                                search = cmd.replace("youtube-vid ","").strip()
                        ...
                        elif cmd == "unfriendall" or cmd == " unfriendall":
                            try:
                                friend = client.getContacts(client.getAllContactIds())
                                client.sendMessage(to,"Waiting delete {} friends".format(len(friend)))
                                for unfriend in friend:
                                    client.deleteContact(unfriend.mid)
                                client.sendMessage(to,"Success delete {} friends".format(len(friend)))
                            except Exception as error:
                                client.sendMessage(to, "「 Result Error 」\n" + str(error))
                                    ...
                                    if targets == []:
                                        ...
                                        for target in targets:
                                            try:
                                                ...
                                                a += "\nMention : @!    "
                                                a += "\nStatus : " + client.getContact(target).statusMessage
                                                a += "\nMid : " + target
   ...
   #                             client.sendMessage(to, str(ret_))
                            ...
                            user = cmd.replace("blockmid ","")
                            client.blockContact(user)
                            client.sendMessage(to, "Success Block Contact.")
                        ...
                        elif cmd == "blocklist" or cmd == " blocklist":
                            blockedlist = client.getBlockedContactIds()
                            kontak = client.getContacts(blockedlist)
                            num=1
                            msgs="「 Block List 」\n"
